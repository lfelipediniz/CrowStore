...
const ProductModal = ({ open, onClose, product, onSave, onRemove }) => {
  ...
  useEffect(() => {
    fetch("/categories/ShowCategories")
      .then((response) => {
        if (response.ok) {
  ...
  const handleSaveModel = () => {
    ...
    axios
      .post("/products/createProductModel", data)
      .then((response) => {
        ...
        axios
          .get(`/products/getModels/${product._id}`)
          .then((response) => {
  ...
  const handleRemove = () => {
    axios
      .delete(`/products/removeProduct/${product._id}`)
      .then(() => {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(`/products/getProductModels/${product?._id}`)
      .then((response) => {
        setProductModels(response.data);
      })
      .catch((error) => {
  ...
  const handleRemoveModel = (modelIndex) => {
    axios
      .delete(
        `/products/deleteProductModel/${product._id}/${modelIndex}`
      )
      .then((response) => {
